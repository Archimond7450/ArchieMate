...
class IncomingMessageSpec extends AnyWordSpecLike with Matchers {
      ...
      "be correctly decoded" in {
        ...
        val expectedMessage = IncomingMessage(
          metadata = Metadata(
            ...
            messageTimestamp = OffsetDateTime.of(
              LocalDateTime.of(2023, 7, 19, 14, 56, 51, 634234626),
              ZoneOffset.UTC
            )
          ),
          payload = Payload(
            session = Some(
              Session(
                ...
                reconnectUrl = None,
                connectedAt = OffsetDateTime.of(
                  LocalDateTime.of(2023, 7, 19, 14, 56, 51, 616329898),
                  ZoneOffset.UTC
                )
              )
            )
        ...
        decode[IncomingMessage](json) shouldEqual Right(expectedMessage)
      }
    }
      ...
      "be correctly decoded" in {
        ...
        val expectedMessage = IncomingMessage(
          metadata = Metadata(
            ...
            messageTimestamp = OffsetDateTime.of(
              LocalDateTime.of(2023, 7, 19, 10, 11, 12, 634234626),
              ZoneOffset.UTC
            )
          ),
          payload = Payload()
      ...
      "be correctly decoded" in {
        ...
        val expectedMessage = IncomingMessage(
          metadata = Metadata(
            ...
            messageTimestamp = OffsetDateTime.of(
              LocalDateTime.of(2022, 11, 16, 10, 11, 12, 464757833),
              ZoneOffset.UTC
            ),
          ...
          payload = Payload(
            subscription = Some(
              Subscription(
                ...
                transport = Transport(
                  method = "websocket",
                  session = Some("AQoQexAWVYKSTIu4ec_2VAxyuhAB")
                ),
            ...
            event = Some(
              ChannelFollowEvent(
                ...
                followedAt = OffsetDateTime.of(
                  LocalDateTime.of(2023, 7, 15, 18, 16, 11, 171067130),
                  ZoneOffset.UTC
                )
              )
            )
      ...
      "be correctly decoded" in {
        ...
        val expectedMessage = IncomingMessage(
          metadata = Metadata(
            ...
            messageTimestamp = OffsetDateTime.of(
              LocalDateTime.of(2022, 11, 18, 9, 10, 11, 634234626),
              ZoneOffset.UTC
            )
          ),
          payload = Payload(
            session = Some(
              Session(
                ...
                connectedAt = OffsetDateTime.of(
                  LocalDateTime.of(2022, 11, 16, 10, 11, 12, 634234626),
                  ZoneOffset.UTC
                )
              )
            )
  ...
  "Notification payloads decoder" when {
    "Automod Message Hold Notification is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/automod.message.hold.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
              ...
              cost = 0,
              condition = Condition(
                broadcasterUserId = Some("1337"),
                moderatorUserId = Some("9001")
              ),
              transport = Transport(
                method = "websocket",
                session = Some("AQoQILE98gtqShGmLD7AM6yJThAB")
              ),
              createdAt = OffsetDateTime.of(
                LocalDateTime.of(2023, 4, 11, 10, 11, 12, 123 * 1000 * 1000),
                ZoneOffset.UTC
              )
            )
          ),
          event = Some(
            AutomodMessageHoldEvent(
              ...
              heldAt = OffsetDateTime
                .of(LocalDateTime.of(2022, 12, 2, 15, 0, 0, 0), ZoneOffset.UTC),
        ...
        decode[Payload](json) shouldEqual Right(expectedPayload)
      }
    }
    ...
    "Automod Message Update Notification is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/automod.message.update.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Automod Settings Update Notification is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/automod.settings.update.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Automod Terms Update Notification is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/automod.terms.update.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Update Notification is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.update.v2.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
              ...
              createdAt = OffsetDateTime.of(
                LocalDateTime.of(2023, 6, 29, 17, 20, 33, 860897266),
                ZoneOffset.UTC
              )
            )
          ),
    ...
    "Channel Follow Notification is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.follow.v2.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
              ...
              createdAt = OffsetDateTime.of(
                LocalDateTime.of(2019, 11, 16, 10, 11, 12, 634234626),
                ZoneOffset.UTC
              )
            )
          ),
          event = Some(
            ChannelFollowEvent(
              ...
              followedAt = OffsetDateTime.of(
                LocalDateTime.of(2020, 7, 15, 18, 16, 11, 171067130),
                ZoneOffset.UTC
              )
            )
          )
    ...
    "Channel Ad Break Begin Notification is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.ad_break.begin.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Chat Clear Notification is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.chat.clear.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Chat Clear User Messages Notification is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.chat.clear_user_messages.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Chat Message Notification is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.chat.message.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
              ...
              cost = 0,
              condition = Condition(
                broadcasterUserId = Some("1971641"),
                userId = Some("2914196")
              ),
              transport = Transport(
                method = "websocket",
                session = Some("AgoQHR3s6Mb4T8GFB1l3DlPfiRIGY2VsbC1h")
              ),
              createdAt = OffsetDateTime.of(
                LocalDateTime.of(2023, 11, 6, 18, 11, 47, 492253549),
                ZoneOffset.UTC
              )
            )
          ),
    ...
    "Channel Chat Message Delete is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.chat.message_delete.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Chat Notification is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.chat.notification.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Chat Settings Update is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.chat_settings.update.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Chat User Message Hold is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.chat.user_message_hold.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
              ...
              message = ChatMessage(
                ...
                fragments = List(
                  ChatMessageFragment(
                    ...
                    cheermote = None,
                    emote =
                      Some(ChatMessageEmote(id = "foo", emoteSetId = "7")),
                    mention = None
                  ),
                  ChatMessageFragment(
                    `type` = "cheermote",
    ...
    "Channel Chat User Message Update is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.chat.user_message_update.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Subscribe is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.subscribe.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Subscription End is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.subscription.end.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Subscription Gift is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.subscription.gift.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Subscription Message is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.subscription.message.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Cheer is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.cheer.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Raid is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.raid.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Ban is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.ban.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
          ...
          event = Some(
            ChannelBanEvent(
              ...
              bannedAt = OffsetDateTime.of(
                LocalDateTime.of(2020, 7, 15, 18, 15, 11, 171067130),
                ZoneOffset.UTC
              ),
              endsAt = Some(
                OffsetDateTime.of(
    ...
    "Channel Unban is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.unban.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Unban Request Create is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.unban_request.create.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
          ...
          event = Some(
            ChannelUnbanRequestCreateEvent(
              ...
              text = "unban me",
              createdAt = OffsetDateTime.of(
                LocalDateTime.of(2023, 11, 16, 10, 11, 12, 634234626),
                ZoneOffset.UTC
              )
            )
          )
    ...
    "Channel Unban Request Resolve is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.unban_request.resolve.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Moderate is received" should {
      "be correctly decoded when adding a moderator" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.moderate.v1/adding_moderator.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
              ...
              createdAt = OffsetDateTime.of(
                LocalDateTime.of(2024, 2, 23, 21, 12, 33, 771005262),
                ZoneOffset.UTC
              )
            )
          ),
      ...
      "be correctly decoded when timing out a user" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.moderate.v1/timing_out.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
            ...
            ChannelModerateEvent(
              ...
              timeout = Some(
                Timeout(
                  ...
                  expiresAt = OffsetDateTime.of(
                    LocalDateTime.of(2022, 3, 15, 2, 0, 28),
                    ZoneOffset.UTC
                  )
                )
              )
      ...
      "be correctly decoded when emote only mode is used" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.moderate.v1/emote_only.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Moderate v2 is received" should {
      "be correctly decoded when issuing a warning" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.moderate.v2/issuing_warning.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
              ...
              cost = 0,
              condition = Condition(
                broadcasterUserId = Some("423374343"),
                moderatorUserId = Some("424596340")
              ),
              transport = Transport(
                method = "websocket",
                session = Some("AgoQHR3s6Mb4T8GFB1l3DlPfiRIGY2VsbC1h")
      ...
      "be correctly decoded when adding a moderator" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.moderate.v2/adding_moderator.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
      ...
      "be correctly decoded when timing out a user" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.moderate.v2/timing_out.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
      ...
      "be correctly decoded when emote only mode is used" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.moderate.v2/emote_only.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Moderator Add is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.moderator.add.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Moderator Remove is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.moderator.remove.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Guest Star Session Begin is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.guest_star_session.begin.vbeta.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
          ...
          event = Some(
            ChannelGuestStarSessionBeginEvent(
              ...
              startedAt = OffsetDateTime.of(
                LocalDateTime.of(2023, 4, 11, 16, 20, 3, 171067130),
                ZoneOffset.UTC
              )
            )
          )
    ...
    "Channel Guest Star Session End is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.guest_star_session.end.vbeta.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
              ...
              createdAt = OffsetDateTime.of(
                LocalDateTime.of(2023, 4, 11, 10, 11, 22, 123 * 1000 * 1000),
                ZoneOffset.UTC
              )
            )
          ),
          event = Some(
            ChannelGuestStarSessionEndEvent(
              ...
              endedAt = OffsetDateTime.of(
                LocalDateTime.of(2023, 4, 11, 17, 51, 29, 153485 * 1000),
                ZoneOffset.UTC
              )
            )
          )
    ...
    "Channel Guest Star Guest Update is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.guest_star_guest.update.vbeta.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
              ...
              createdAt = OffsetDateTime.of(
                LocalDateTime.of(2023, 4, 11, 10, 11, 32, 123 * 1000 * 1000),
                ZoneOffset.UTC
              )
            )
          ),
    ...
    "Channel Guest Star Settings Update is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.guest_star_settings.update.vbeta.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
              ...
              createdAt = OffsetDateTime.of(
                LocalDateTime.of(2023, 4, 11, 10, 11, 52, 123 * 1000 * 1000),
                ZoneOffset.UTC
              )
            )
          ),
    ...
    "Channel Points Automatic Reward Add is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.channel_points_automatic_reward_redemption.add.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
          ...
          event = Some(
            ChannelPointsAutomaticRewardRedemptionAddEvent(
              ...
              redeemedAt = OffsetDateTime.of(
                LocalDateTime.of(2024, 2, 23, 21, 14, 34, 260398045),
                ZoneOffset.UTC
              )
            )
          )
    ...
    "Channel Points Custom Reward Add is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.channel_points_custom_reward.add.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
          ...
          event = Some(
            ChannelPointsCustomRewardAddEvent(
              ...
              maxPerUserPerStream =
                MaxPerStream(isEnabled = true, value = 1000),
    ...
    "Channel Points Custom Reward Update is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.channel_points_custom_reward.update.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Points Custom Reward Remove is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.channel_points_custom_reward.remove.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
          ...
          event = Some(
            ChannelPointsCustomRewardRemoveEvent(
              ...
              cooldownExpiresAt = Some(
                OffsetDateTime.of(
                  LocalDateTime.of(2019, 11, 16, 10, 11, 12, 123 * 1000 * 1000),
                  ZoneOffset.UTC
                )
              ),
              redemptionsRedeemedCurrentStream = Some(123)
    ...
    "Channel Points Custom Reward Redemption Add is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.channel_points_custom_reward_redemption.add.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
              ...
              condition = Condition(
                broadcasterUserId = Some("1337"),
                rewardId = Some("92af127c-7326-4483-a52b-b0da0be61c01")
              ),
              transport = Transport(
                method = "websocket",
                session = Some("AgoQHR3s6Mb4T8GFB1l3DlPfiRIGY2VsbC1h")
          ...
          event = Some(
            ChannelPointsCustomRewardRedemptionAddEvent(
              ...
              redeemedAt = OffsetDateTime.of(
                LocalDateTime.of(2020, 7, 15, 17, 16, 3, 171067130),
                ZoneOffset.UTC
              )
            )
          )
    ...
    "Channel Points Custom Reward Redemption Update is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.channel_points_custom_reward_redemption.update.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Poll Begin is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.poll.begin.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
          ...
          event = Some(
            ChannelPollBeginEvent(
              ...
              channelPointsVoting =
                ChannelPointsVoting(isEnabled = true, amountPerVote = 10),
              startedAt = OffsetDateTime.of(
                LocalDateTime.of(2020, 7, 15, 17, 16, 3, 171067130),
                ZoneOffset.UTC
              ),
              endsAt = OffsetDateTime.of(
                LocalDateTime.of(2020, 7, 15, 17, 16, 8, 171067130),
                ZoneOffset.UTC
              )
            )
          )
    ...
    "Channel Poll Progress is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.poll.progress.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Poll End is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.poll.end.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
          ...
          event = Some(
            ChannelPollEndEvent(
              ...
              endedAt = OffsetDateTime.of(
                LocalDateTime.of(2020, 7, 15, 17, 16, 11, 171067130),
                ZoneOffset.UTC
              )
            )
          )
    ...
    "Channel Prediction Begin is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.prediction.begin.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
          ...
          event = Some(
            ChannelPredictionBeginEvent(
              ...
              locksAt = OffsetDateTime.of(
                LocalDateTime.of(2020, 7, 15, 17, 21, 3, 171067130),
                ZoneOffset.UTC
              )
            )
          )
    ...
    "Channel Prediction Progress is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.prediction.progress.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Prediction Lock is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.prediction.lock.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Prediction End is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.prediction.end.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Suspicious User Update is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.suspicious_user.update.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
              ...
              cost = 0,
              condition = Condition(
                broadcasterUserId = Some("1050263435"),
                moderatorUserId = Some("1050263436")
              ),
              transport = Transport(
                method = "websocket",
                session = Some("AgoQHR3s6Mb4T8GFB1l3DlPfiRIGY2VsbC1h")
    ...
    "Channel Suspicious User Message is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.suspicious_user.message.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
              ...
              cost = 0,
              condition = Condition(
                broadcasterUserId = Some("1050263432"),
                moderatorUserId = Some("9001")
              ),
              transport = Transport(
                method = "websocket",
              ...
              message = MessageWithIdAndFragments(
                ...
                fragments = List(
                  ChatMessageFragment(
                    ...
                    cheermote = None,
                    emote =
                      Some(ChatMessageEmote(id = "899", emoteSetId = "1")),
                    mention = None
                  ),
                  ChatMessageFragment(
                    `type` = "cheermote",
    ...
    "Channel VIP Add is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.vip.add.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel VIP Remove is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.vip.remove.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Warning Acknowledge is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.warning.acknowledge.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Warning Send is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.warning.send.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Hype Train Begin is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.hype_train.begin.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Hype Train Progress is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.hype_train.progress.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Hype Train End is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.hype_train.end.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
          ...
          event = Some(
            ChannelHypeTrainEndEvent(
              ...
              cooldownEndsAt = OffsetDateTime.of(
                LocalDateTime.of(2020, 7, 15, 18, 16, 11, 171067130),
                ZoneOffset.UTC
              )
            )
    ...
    "Channel Charity Campaign Donate is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.charity_campaign.donate.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
              ...
              createdAt = OffsetDateTime.of(
                LocalDateTime.of(2022, 7, 25, 10, 11, 12, 123 * 1000 * 1000),
                ZoneOffset.UTC
              )
            )
          ),
          event = Some(
            ChannelCharityDonationEvent(
    ...
    "Channel Charity Campaign Start is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.charity_campaign.start.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
              ...
              createdAt = OffsetDateTime.of(
                LocalDateTime.of(2022, 7, 25, 10, 11, 12, 123398240),
                ZoneOffset.UTC
              )
            )
          ),
          event = Some(
            ChannelCharityCampaignStartEvent(
              ...
              charityWebsite = "https://www.example.com",
              currentAmount =
                Amount(value = 0, decimalPlace = 2, currency = "USD"),
              targetAmount =
                Amount(value = 1500000, decimalPlace = 2, currency = "USD"),
              startedAt = OffsetDateTime.of(
                LocalDateTime.of(2022, 7, 26, 17, 0, 3, 171067130),
                ZoneOffset.UTC
              )
            )
          )
    ...
    "Channel Charity Campaign Progress is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.charity_campaign.progress.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
          ...
          event = Some(
            ChannelCharityCampaignProgressEvent(
              ...
              charityWebsite = "https://www.example.com",
              currentAmount =
                Amount(value = 260000, decimalPlace = 2, currency = "USD"),
              targetAmount =
                Amount(value = 1500000, decimalPlace = 2, currency = "USD")
            )
          )
    ...
    "Channel Charity Campaign Stop is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.charity_campaign.stop.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
          ...
          event = Some(
            ChannelCharityCampaignStopEvent(
              ...
              charityWebsite = "https://www.example.com",
              currentAmount =
                Amount(value = 1450000, decimalPlace = 2, currency = "USD"),
              targetAmount =
                Amount(value = 1500000, decimalPlace = 2, currency = "USD"),
              stoppedAt = OffsetDateTime.of(
                LocalDateTime.of(2022, 7, 26, 22, 0, 3, 171067130),
                ZoneOffset.UTC
              )
            )
          )
    ...
    "Channel Shield Mode Begin is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.shield_mode.begin.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
              ...
              cost = 0,
              condition = Condition(
                broadcasterUserId = Some("12345"),
                moderatorUserId = Some("98765")
              ),
              transport = Transport(
                method = "websocket",
                session = Some("AgoQHR3s6Mb4T8GFB1l3DlPfiRIGY2VsbC1h")
              ...
              createdAt = OffsetDateTime.of(
                LocalDateTime.of(2022, 7, 25, 10, 11, 12, 123673900),
                ZoneOffset.UTC
              )
            )
          ),
    ...
    "Channel Shield Mode End is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.shield_mode.end.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
          ...
          event = Some(
            ChannelShieldModeEndEvent(
              ...
              moderatorUserName = "ParticularlyParticular123",
              endedAt = OffsetDateTime.of(
                LocalDateTime.of(2022, 7, 27, 1, 30, 23, 171067130),
                ZoneOffset.UTC
              )
            )
          )
    ...
    "Channel Shoutout Create is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.shoutout.create.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
          ...
          event = Some(
            ChannelShoutoutCreateEvent(
              ...
              viewerCount = 860,
              cooldownEndsAt = OffsetDateTime.of(
                LocalDateTime.of(2022, 7, 26, 17, 2, 3, 171067130),
                ZoneOffset.UTC
              ),
              targetCooldownEndsAt = OffsetDateTime.of(
                LocalDateTime.of(2022, 7, 26, 18, 0, 3, 171067130),
                ZoneOffset.UTC
              )
            )
          )
    ...
    "Channel Shoutout Receive is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.shoutout.receive.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Conduit Shard Disabled is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/conduit.shard.disabled.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
              ...
              cost = 0,
              condition =
                Condition(clientId = Some("uo6dggojyb8d6soh92zknwmi5ej1q2")),
              transport = Transport(
                method = "websocket",
                session = Some("AgoQHR3s6Mb4T8GFB1l3DlPfiRIGY2VsbC1h")
              ),
          ...
          event = Some(
            ConduitShardDisabledEvent(
              ...
              transport = Transport(
                ...
                connectedAt = Some(
                  OffsetDateTime.of(
                    LocalDateTime.of(2020, 11, 10, 14, 32, 18, 730260295),
                    ZoneOffset.UTC
                  )
                ),
                disconnectedAt = Some(
                  OffsetDateTime.of(
                    LocalDateTime.of(2020, 11, 11, 14, 32, 18, 730260295),
                    ZoneOffset.UTC
                  )
                )
              )
    ...
    "Drop Entitlement Grant is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/drop.entitlement.grant.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
              ...
              cost = 0,
              condition = Condition(
                organizationId = Some("9001"),
                categoryId = Some("9002"),
                campaignId = Some("9003")
              ),
              transport = Transport(
                method = "webhook",
                callback = Some("https://example.com/webhooks/callback")
              ),
              createdAt = OffsetDateTime.of(
                LocalDateTime.of(2019, 11, 16, 10, 11, 12, 634234626),
                ZoneOffset.UTC
              ...
              List(
                DropEntitlementGrantEvent(
                  ...
                  data = Entitlement(
                    ...
                    createdAt = OffsetDateTime.of(
                      LocalDateTime
                        .of(2019, 1, 28, 4, 17, 53, 325 * 1000 * 1000),
                      ZoneOffset.UTC
                    )
                  )
                ),
    ...
    "Extension Bits Transaction Create" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/extension.bits_transaction.create.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Goal Begin is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.goal.begin.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
              ...
              createdAt = OffsetDateTime.of(
                LocalDateTime.of(2021, 7, 15, 10, 11, 12, 123 * 1000 * 1000),
                ZoneOffset.UTC
              )
            )
          ),
          event = Some(
            ChannelGoalBeginEvent(
              ...
              targetAmount = 220,
              startedAt = OffsetDateTime.of(
                LocalDateTime.of(2021, 7, 15, 17, 16, 3, 171067130),
                ZoneOffset.UTC
              )
            )
          )
    ...
    "Channel Goal Progress is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.goal.progress.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Channel Goal End is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/channel.goal.end.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
          ...
          event = Some(
            ChannelGoalEndEvent(
              ...
              endedAt = OffsetDateTime.of(
                LocalDateTime.of(2020, 7, 16, 17, 16, 3, 171067130),
                ZoneOffset.UTC
              )
            )
          )
    ...
    "Stream Online is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/stream.online.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
          ...
          event = Some(
            StreamOnlineEvent(
              ...
              `type` = "live",
              startedAt = OffsetDateTime.of(
                LocalDateTime.of(2020, 10, 11, 10, 11, 12, 123 * 1000 * 1000),
                ZoneOffset.UTC
              )
            )
          )
    ...
    "Stream Offline is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/stream.offline.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "User Authorization Grant is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/user.authorization.grant.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
              ...
              cost = 1,
              condition =
                Condition(clientId = Some("crq72vsaoijkc83xx42hz6i37")),
              transport = Transport(
                method = "webhook",
                callback = Some("https://example.com/webhooks/callback")
              ),
    ...
    "User Authorization Revoke is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/user.authorization.revoke.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "User Update is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/user.update.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
    ...
    "Whisper Received is received" should {
      "be correctly decoded" in {
        val json = readFile(
          s"$TEST_JSON_DIRECTORY/notification_payloads/user.whisper.message.v1.json"
        )
        val expectedPayload = Payload(
          subscription = Some(
            Subscription(
  ...
  "Session encoder" when {
    "Session object is provided" should {
      "correctly encode it" in {
        ...
        request.asJson.spaces2 shouldEqual expectedJson
      }
    }
  }
}
