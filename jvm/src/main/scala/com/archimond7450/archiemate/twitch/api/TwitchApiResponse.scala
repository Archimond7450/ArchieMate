...
object TwitchApiResponse {
  ...
  final case class GameResponse(game: Option[TwitchApi.Game])
      extends TwitchApiResponse
  object GameResponse {
  ...
  case class GameNotFoundException(gameName: String)
      extends RuntimeException(s"Game with name $gameName was not found.")

  final case class GetGames(data: List[TwitchApi.Game])
      extends TwitchApiResponse
  object GetGames {
  ...
  final case class GetChannelInformation(data: List[ChannelInformation])
      extends TwitchApiResponse
  ...
  final case class GetSubs(
      data: List[TwitchApi.SubbedUser],
      pagination: TwitchApi.Pagination,
      total: Int,
      points: Int
  ) extends TwitchApiResponse
  ...
  final case class GetChannelFollowers(
      total: Int,
      data: List[TwitchApi.UserFollowage],
      pagination: TwitchApi.Pagination
  ) extends TwitchApiResponse
  ...
  final case class CheckUserFollowage(
      followage: Option[TwitchApi.UserFollowage]
  ) extends TwitchApiResponse
  ...
  final case class CreateEventSubWebsocketSubscriptionResponse(
  ...
  object CreateEventSubWebsocketSubscriptionResponse {
    given Decoder[CreateEventSubWebsocketSubscriptionResponse] =
      ConfiguredDecoder.derived
    given Encoder[CreateEventSubWebsocketSubscriptionResponse] =
      ConfiguredEncoder.derived
  }

  final case class GetStream(
      data: List[TwitchApi.Stream],
      pagination: TwitchApi.Pagination
  ) extends TwitchApiResponse
  object GetStream {
  ...
  final case class GetGlobalEmotes(
      data: List[TwitchApi.Emote],
      template: String
  ) extends TwitchApiResponse
  ...
  final case class GetEmoteSets(
      data: List[TwitchApi.EmoteWithSet],
      template: String
  ) extends TwitchApiResponse
  object GetEmoteSets {
