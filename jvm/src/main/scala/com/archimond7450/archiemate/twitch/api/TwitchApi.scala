...
object TwitchApi {
  ...
  final case class UserFollowage(
      user_id: String,
      user_name: String,
      user_login: String,
  ...
  final case class Poll(
      ...
      bitsVotingEnabled: Option[Boolean],
      bitsPerVote: Option[Int],
