...
object ChannelSettings {
  final case class Settings(
                       ...
                       builtInCommandsSettings: BuiltInCommandsSettings = BuiltInCommandsSettings(),
                       ...
                       automaticMessagesSettings: AutomaticMessagesSettings = AutomaticMessagesSettings()
                     )
  ...
  final case class TimersSettings(
                             ...
                             youTubeVideosOccurrence: YouTubeVideosOccurrence = YouTubeVideosOccurrence.Never,
